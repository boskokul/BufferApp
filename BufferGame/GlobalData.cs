namespace BufferGame
{
    ...
    {
        public enum Code { CODE_ANALOG, CODE_DIGITAL, CODE_CUSTOM, CODE_LIMITSET, CODE_SINGLENODE, CODE_MULTIPLENODE, CODE_PRODUCER, CODE_DESTINATION }
        ...
        static GlobalData()
        {
            ...
            DatasetCodes[Code.CODE_MULTIPLENODE] = 3;
